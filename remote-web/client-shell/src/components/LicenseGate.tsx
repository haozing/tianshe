...
const DESKTOP_SETUP_DOWNLOAD_URL = "http://chihu.facaishe.cn/desktop/win/chihu-guanjia-2.1.9-phase2-setup.exe";
const DESKTOP_SETUP_FILE_NAME = "chihu-guanjia-2.1.9-phase2-setup.exe";
