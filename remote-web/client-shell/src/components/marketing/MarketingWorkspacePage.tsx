...
export function MarketingWorkspacePage({ feature }: { feature: MarketingFeature }) {
  ...
  const filteredEntities = entities.filter((entity) => {
    ...
    return matchesText && matchesStatus && matchesActivityType && matchesDiscountType && matchesMinimum && matchesMaximum && startsAfter && endsBefore;
  });
