...
export const DIRECT_CONSOLE_CALL_BASELINE: Record<string, number> = {
  ...
  'src/core/js-plugin/namespaces/account.ts': 4,
  ...
  'src/main/duckdb/account-service.ts': 6,
  ...
  'src/main/duckdb/tag-service.ts': 3,
  ...
  'src/main/ipc.ts': 1,
  'src/main/ipc-handlers/account-ipc-handler.ts': 11,
  'src/main/ipc-handlers/dataset-folder-handler-bootstrap.ts': 1,
  'src/main/ipc-handlers/dataset-folder-handler.ts': 9,
  'src/main/ipc-handlers/dataset-routes/import-export-routes.ts': 2,
  'src/main/ipc-handlers/dataset-routes/metadata-routes.ts': 3,
  'src/main/ipc-handlers/dataset-routes/query-preview-routes.ts': 5,
  'src/main/ipc-handlers/dataset-routes/record-routes.ts': 2,
  'src/main/ipc-handlers/dataset-routes/route-utils.ts': 1,
  ...
  'src/main/ipc-handlers/js-plugin-routes/config-routes.ts': 3,
  'src/main/ipc-handlers/js-plugin-routes/lifecycle-routes.ts': 3,
  'src/main/ipc-handlers/js-plugin-routes/ui-extension-routes.ts': 5,
  'src/main/ipc-handlers/js-plugin-routes/view-routes.ts': 3,
  ...
  'src/main/ipc-handlers/scheduler-handler.ts': 1,
  'src/main/ipc-handlers/sync-engine-ipc-handler.ts': 1,
  'src/main/ipc-handlers/sync-metadata-ipc-handler.ts': 1,
  'src/main/ipc-handlers/sync-outbox-ipc-handler.ts': 1,
