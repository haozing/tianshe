...
export class HttpApiIPCHandler {
  ...
  private registerSetConfig(): void {
    ipcRouteRegistry.register({
      channel: 'http-api:set-config',
      kind: 'handle',
      permission: 'trusted-renderer',
      handler: async (event: IpcMainInvokeEvent, config: Partial<HttpApiConfig>) => {
        try {
  ...
  private registerGetRuntimeStatus(): void {
    ipcRouteRegistry.register({
      channel: 'http-api:get-runtime-status',
      kind: 'handle',
      permission: 'trusted-renderer',
      handler: async (event: IpcMainInvokeEvent) => {
        try {
  ...
  private registerRepairRuntime(): void {
    ipcRouteRegistry.register({
      channel: 'http-api:repair-runtime',
      kind: 'handle',
      permission: 'trusted-renderer',
      handler: async (event: IpcMainInvokeEvent) => {
        try {
